        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VehiclesLicensePlateNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VehicleFirstReleaseDate = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VehicleOwnersFullName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VehiclesBrand = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExtractedFields_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExtractedFields_UserId",
